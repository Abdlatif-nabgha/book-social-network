...
export function deleteFeedback(http: HttpClient, rootUrl: string, params: DeleteFeedback$Params, context?: HttpContext): Observable<StrictHttpResponse<ApiResponseVoid>> {
